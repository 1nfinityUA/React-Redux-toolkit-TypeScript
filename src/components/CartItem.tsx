...
type CartItemPropsType ={title: string, price: number, type: string, id: string, size: number, count: number, imageUrl: string}

const CartItem: React.FC<CartItemPropsType> = ({title, price, type, id, size, count, imageUrl}) => {
...
const onClickRemove =()=> {
    if (window.confirm('Ти дійсно хочешь видалити?')){
